...
function parseUserConfig(userConfig = {}) {
  ...
  return {
    ...
    enablePalantir:
      userConfig.enablePalantir !== 'false' && isPalantirConfigured(userConfig),
  }
}

function hasEnabledPalantir(userOpts, userConfig = {}) {
  return userOpts.enablePalantir && isPalantirConfigured(userConfig)
}
